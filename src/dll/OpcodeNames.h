...
// 1.12 opcodes of the auth -> char-select flow plus the client's renumbered client->server opcodes;
// returns nullptr for anything not catalogued, so the log falls back to the raw number.
namespace uoa::op {
